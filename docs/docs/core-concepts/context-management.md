...
Another use for manual context loading is for context types that can't be loaded automatically, like URLs, notes, or piped data (for now Gpt4cli can only automatically load project files and images within the project).
