...
- If you started a free trial of Gpt4cli Cloud with BYO Key mode, you can now switch to a trial of Integrated Models mode if desired from your [billing dashboard](https://app.gpt4cli.khulnasoft.com/settings/billing) (use `\billing` from the REPL to open the dashboard).
