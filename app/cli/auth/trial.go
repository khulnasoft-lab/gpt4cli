...
func ConvertTrial() {
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for upgrade. Please try again. Email support@gpt4cli.ai if the problem persists.")
}
...
func startTrial() {
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for trial to start. Please try again. Email support@gpt4cli.ai if the problem persists.")
}
