...
DO NOT FORGET TO INCLUDE THE ***'g4c-' PREFIXED*** LINE NUMBERS IN THE <Old> ELEMENT.
`
...
Original file (with line nums prefixed with 'g4c-'):
>>>
%s
<<<
...
Proposed changes (with line nums prefixed with 'g4c-new-'):
>>>
%s
<<<
`,
